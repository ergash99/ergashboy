...
<div class="adminbody">
    <div class="table_border">
        ...
        <div class="breadcrumb-wrapper" style="float: left;">
            <h2 class="mainTitle no-margin" style="margin-left: 50px">Сметалар </h2>
        </div>
        <div class="panel-body">
            <div class="text-right">
                <a type="button" class="btn green-haze btn-outline sbold uppercase"
                   href="<%=SmetaController.URL_SMETA_EDIT%>"  ><spring:message code="button.add"/> </a>
            </div>
        </div>
                        ...
                        <div class="panel panel-white">
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <jsp:include page="smeta-table.jsp"/>
                                </div>
                            </div>
                        </div>
